...
function App() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("versionCode") === "fall-22-23") {
      localStorage.clear();
      localStorage.setItem("versionCode", "winter-22-23");
    }
  }, []);
  ...
  useEffect(() => {
    ...
    const randomNumberArray = [
      30, 36, 46, 0, 17, 47, 33, 20, 13, 44, 5, 43, 19, 40, 2, 4, 6, 22, 28, 42,
      39, 26, 21, 27, 37, 15, 29, 18, 14, 3, 1, 34, 35, 25, 31, 16, 24, 23, 10,
      32, 45, 12, 7, 8, 38, 41, 11, 9, 30, 36, 46, 0, 17, 47, 33, 20, 13, 44, 5,
      43, 19, 40, 2, 4, 6, 22, 28, 42, 39, 26, 21, 27, 37, 15, 29, 18, 14, 3, 1,
      34, 35, 25, 31, 16, 24, 23, 10, 32, 45, 12, 7, 8, 38, 41, 11, 9, 30, 36,
      46, 0, 17, 47, 33, 20, 13, 44, 5, 43, 19, 40, 2, 4, 6, 22, 28, 42, 39, 26,
      21, 27, 37, 15, 29, 18, 14, 3, 1, 34, 35, 25, 31, 16, 24, 23, 10, 32, 45,
      12, 7, 8, 38, 41, 11, 9, 30, 36, 46, 0, 17, 47, 33, 20, 13, 44, 5, 43, 19,
      40, 2, 4, 6, 22, 28, 42, 39, 26, 21, 27, 37, 15, 29, 18, 14, 3, 1, 34, 35,
      25, 31, 16, 24, 23, 10, 32, 45, 12, 7, 8, 38, 41, 11, 9, 30, 36, 46, 0,
      17, 47, 33, 20, 13, 44, 5, 43, 19, 40, 2, 4, 6, 22, 28, 42, 39, 26, 21,
      27, 37, 15, 29, 18, 14, 3, 1, 34, 35, 25, 31, 16, 24, 23, 10, 32, 45, 12,
      7, 8, 38, 41, 11, 9, 30, 36, 46, 0, 17, 47, 33, 20, 13, 44, 5, 43, 19, 40,
      2, 4, 6, 22, 28, 42, 39, 26, 21, 27, 37, 15, 29, 18, 14, 3, 1, 34, 35, 25,
      31, 16, 24, 23, 10, 32, 45, 12, 7, 8, 38, 41, 11, 9, 30, 36, 46, 0, 17,
      47, 33, 20, 13, 44, 5, 43, 19, 40, 2, 4, 6, 22, 28, 42, 39, 26, 21, 27,
      37, 15, 29, 18, 14, 3, 1, 34, 35, 25, 31, 16, 24, 23, 10, 32, 45, 12, 7,
      8, 38, 41, 11, 9, 30, 36, 46, 0, 17, 47, 33, 20, 13, 44, 5, 43, 19, 40, 2,
      4, 6, 22, 28, 42, 39, 26, 21, 27, 37, 15, 29, 18, 14, 3, 1, 34, 35, 25,
      31, 16, 24, 23, 10, 32, 45, 12, 7, 8, 38, 41, 11, 9, 30, 36, 46, 0, 17,
      47, 33, 20, 13, 44, 5, 43, 19, 40, 2, 4, 6, 22, 28, 42, 39, 26, 21, 27,
      37, 15, 29, 18, 14, 3, 1, 34, 35, 25, 31, 16, 24, 23, 10, 32, 45, 12, 7,
      8, 38, 41, 11, 9, 30, 36, 46, 0, 17, 47, 33, 20, 13, 44, 5, 43, 19, 40, 2,
    ...
    var dateArray = getDates(
      selectedDate(new Date(2023, 2, 15)),
