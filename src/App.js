...
function App() {
  ...
  useEffect(() => {
    ...
    const randomNumberArray = [
      21, 11, 41, 37, 43, 31, 28, 32, 4, 8, 30, 47, 1, 7, 17, 18, 20, 27, 26,
      22, 2, 16, 19, 34, 0, 39, 24, 9, 29, 25, 14, 3, 33, 36, 46, 12, 10, 15,
      35, 6, 44, 5, 45, 42, 40, 13, 23, 38, 21, 11, 41, 37, 43, 31, 28, 32, 4,
      8, 30, 47, 1, 7, 17, 18, 20, 27, 26, 22, 2, 16, 19, 34, 0, 39, 24, 9, 29,
      25, 14, 3, 33, 36, 46, 12, 10, 15, 35, 6, 44, 5, 45, 42, 40, 13, 23, 38,
      21, 11, 41, 37, 43, 31, 28, 32, 4, 8, 30, 47, 1, 7, 17, 18, 20, 27, 26,
      22, 2, 16, 19, 34, 0, 39, 24, 9, 29, 25, 14, 3, 33, 36, 46, 12, 10, 15,
      35, 6, 44, 5, 45, 42, 40, 13, 23, 38, 21, 11, 41, 37, 43, 31, 28, 32, 4,
      8, 30, 47, 1, 7, 17, 18, 20, 27, 26, 22, 2, 16, 19, 34, 0, 39, 24, 9, 29,
    ...
    var dateArray = getDates(
      selectedDate(new Date(2022, 10, 14)),
      selectedDate(new Date(2023, 10, 14))
    );
