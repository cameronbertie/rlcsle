...
export default function Header(props) {
  ...
  useEffect(() => {
    setShowInstructions(JSON.parse(localStorage.getItem("showInstructionsSpring23")  === null || JSON.parse(localStorage.getItem("showInstructionsSpring23")) === true ? true:false));
    
  }, [])

  useEffect(() => {
    localStorage.setItem("showInstructionsSpring23", JSON.stringify(showInstructions));
...
setTrigger={setShowFirstStats}
      ...
      <header className="header-container">
        ...
        <h2 className="secondary-heading">2022-2023 SPRING MAJOR EDITION</h2>
